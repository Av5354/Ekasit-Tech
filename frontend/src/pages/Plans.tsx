  ...
  <div>
    ...
    <section className="relative isolate overflow-hidden bg-[#070012] py-24 text-center">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <h1 className="text-4xl font-bold text-[#efe1ff] drop-shadow-[0_0_42px_rgba(149,74,255,0.38)] mb-6 sm:text-5xl md:text-7xl">
          Flexible{" "}
    ...
    <section className="relative isolate overflow-hidden bg-[#070012] px-4 py-16">
